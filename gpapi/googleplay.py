...
class GooglePlayAPI(object):
    ...
    def __init__(self, locale, timezone, device_codename='bullhead',
                 proxies_config=None):
    ...
    def getDefaultHeaders(self):
        ...
        headers = {"Accept-Language": self.deviceBuilder.locale.replace('_', '-'),
                  ...
                  # "X-DFE-UserLanguages": self.deviceBuilder.locale,
    ...
    def uploadDeviceConfig(self):
        ...
        selected in the __init__ method to the google account."""
    ...
    def login(self, email=None, password=None, gsfId=None, authSubToken=None):
        ...
        if email is not None and password is not None:
            ...
            #headers = self.deviceBuilder.getAuthHeaders(self.gsfId) #cleanup
            #headers['app'] = 'com.google.android.gsm' #cleanup
    ...
    def list(self, cat, ctr=None, nb_results=None, offset=None):
        ...
        if offset is not None:
            ...
            path += "&ctntkn=" + get_token(int(offset))
        data = self.executeRequestApi2(path)
        if ctr is None:
            # list subcategories
            clusters = chain.from_iterable([pf.response.payload.listResponse.cluster
